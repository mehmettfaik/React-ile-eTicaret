    ...
    return (
        ...
        <div style={{ marginTop: '40px', display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
            ...
            <div>
                ...
                <CiCircleMinus onClick={decrement} style={{ fontSize: '40px', marginRight: '15px' }} />   <span style={{ fontSize: '35px' }}>{count}</span> <CiCirclePlus onClick={increment} style={{ fontSize: '40px', marginLeft: '15px' }} />
                </div>
